...
|-----------|--------------|--------|
| plant | `src/plant.cc` `inc/plant.h` | — |
| observer | `src/observer.cc` `inc/observer.h` | plant |
| controller | `src/controller.cc` `inc/controller.h` | plant, observer |
| adaptive | `src/adaptive.cc` `inc/adaptive.h` | observer, controller |
| main | `src/main.cc` `inc/params.h` `inc/csv_writer.h` | plant, observer, controller, adaptive |
| scripts | `scripts/**` | — |
| config | `config/**` | — |
| docs | `docs/**` `CLAUDE.md` | plant, observer, controller, adaptive |
